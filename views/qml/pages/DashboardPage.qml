...
Item {
    ...
    Popup {
        ...
        Column {
            ...
            AppTextField { id: savePath; label: "File path"; placeholderText: "e.g. data/sample_network.json" }
            Row {
                width: parent.width
                spacing: DS.Layout.s_mm
    ...
    Popup {
        ...
        Column {
            ...
            AppTextField { id: loadPath; label: "File path"; placeholderText: "e.g. data/sample_network.json" }
            Row {
                width: parent.width
                spacing: DS.Layout.s_mm
